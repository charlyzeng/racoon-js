...
export default class SchemaObject extends SchemaBase {
   ...
   * that is not included in config. If allowUnknown is called, then these unknown
   * keys will be allowed, and these unknown key-values will be returned in validate
   * result.
   */
  allowUnknown() {
   ...
   * @param {array}  options.chain  The key chain of ancestors to give friendly error prompts.
